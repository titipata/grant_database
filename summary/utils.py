...
def scatter_with_hover(df, x, y,
    ...
    **kwargs
    ...
    ref: http://blog.rtwilson.com/bokeh-plots-with-dataframe-based-tooltips/
    """
    ...
    #                   """
    #                   <div class="tooltip">
    #                       <span style="font-family: Lato; font-size: 12px; font-weight: normal;">@year</span><br>
    #                       <span style="font-family: Lato; font-size: 12px; font-weight: normal;">@n_grants</span><br>
    #                       <span style="font-family: Lato; font-size: 12px; font-weight: normal;">@amount</span>
    #                   </div>
    #                   """)
